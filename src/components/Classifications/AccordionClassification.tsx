...
// export default function AccordionClassification({ title, children }: {title :any, children: React.ReactNode}) {
//     const [open, setOpen] = useState(false);

//     return (
//         <div className="border rounded-[10px] w-full xl:w-[60%] overflow-hidden">
//             <button
